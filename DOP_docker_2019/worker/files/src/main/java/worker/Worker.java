...
class Worker {
  public static void main(String[] args) {
	...
	if (postgresHost == null)
		postgresHost = "postgress";
        Jedis redis = connectToRedis(redisHost);
        Connection dbConn = connectToDB(postgresHost, postgresUser, postgresPassword);
  ...
  static Jedis connectToRedis(String host) {
	...
	static Connection connectToDB(String host, String user, String password) throws SQLException {
