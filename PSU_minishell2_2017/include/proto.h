...
void check_signals(int, app_info_t *);
...
int main_loop(char **, env_t *);
int display_processus(env_t *, char **, app_info_t *);
int check_processus_killed_or_env(char *, app_info_t *);
...
void free_path_variable(char **);
void search_exec(char *, char **, env_t *, app_info_t *);
...
void start_forking(char **, env_t *, app_info_t *);
char **convert_list_into_board(env_t *);
char **list_to_board(env_t *, char **, unsigned int);
void add_or_remove_env_variable(env_t **, char *, app_info_t *);
...
void add_variable(env_t **, char *, app_info_t *);
void remove_variable(env_t **, char *, app_info_t *);
...
void launch_cd(char *, env_t **, app_info_t *);
int check_path(char *, env_t **, app_info_t *);
char *organize_str(char *, int);
void get_back_to_home(env_t **, app_info_t *);
void get_back_to_previous_location(env_t **, app_info_t *);
void initialise_old_pwd_variable(env_t **, app_info_t *);
void add_old_pwd(env_t **);
int check_file_stat(char *, app_info_t *);
int check_file_stat_exec(char *, app_info_t *);
